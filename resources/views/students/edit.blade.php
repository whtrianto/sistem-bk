...
<div class="container-fluid fade-in-section">
    <div class="mb-4">
        ...
        <h3 class="fw-bold mt-2 text-dark">Edit Data Siswa: {{ $student->user->name }}</h3>
    </div>
    ...
    <form action="{{ route('students.update', $student) }}" method="POST" class="row g-4">
        @csrf
        @method('PUT')
        ...
        <div class="col-lg-6">
            <div class="card border-0 glass-card p-4 h-100">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control" required value="{{ old('name', $student->user->name) }}">
                </div>

                <div class="mb-3">
                    <label for="email" class="form-label fw-semibold">Alamat Email <span class="text-danger">*</span></label>
                    <input type="email" name="email" id="email" class="form-control" required value="{{ old('email', $student->user->email) }}">
                </div>
        ...
        <div class="col-lg-6">
            <div class="card border-0 glass-card p-4 h-100">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nis" id="nis" class="form-control" required value="{{ old('nis', $student->nis) }}">
                </div>

                <div class="mb-3">
                    <label for="nisn" class="form-label fw-semibold">NISN</label>
                    <input type="text" name="nisn" id="nisn" class="form-control" value="{{ old('nisn', $student->nisn) }}">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="birth_place" id="birth_place" class="form-control" value="{{ old('birth_place', $student->birth_place) }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="birth_date" class="form-label fw-semibold">Tanggal Lahir</label>
                        <input type="date" name="birth_date" id="birth_date" class="form-control" value="{{ old('birth_date', $student->birth_date ? $student->birth_date->format('Y-m-d') : '') }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card border-0 glass-card p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="parent_phone" class="form-label fw-semibold">Nomor WhatsApp Orang Tua</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="parent_address" id="parent_address" class="form-control" rows="3">{{ old('parent_address', $student->parent_address) }}</textarea>
                    </div>
                </div>

                <div class="text-end mt-4">
                    <button type="submit" class="btn btn-primary-custom px-5 py-2"><i class="bi bi-save me-2"></i> Perbarui Data Siswa</button>
                </div>
            </div>
        </div>
    </form>
