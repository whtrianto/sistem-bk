            ...
            <div class="card border-0 glass-card p-4">
                <form action="{{ route('violation-types.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Terlambat, Merokok" required value="{{ old('name') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="points" id="points" class="form-control" placeholder="Contoh: 5, 10, 25" required min="1" value="{{ old('points') }}">
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label fw-semibold">Keterangan / Deskripsi Pelanggaran</label>
                        <textarea name="description" id="description" class="form-control" rows="3" placeholder="Masukkan detail penjelasan pelanggaran...">{{ old('description') }}</textarea>
                    </div>
