                    ...
                    <form action="{{ route('violation-types.update', $violationType) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="points" class="form-label fw-semibold">Bobot Poin Pelanggaran <span
                                    class="text-danger">*</span></label>
                            <input type="number" name="points" id="points" class="form-control" required min="1"
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-primary-custom px-4"><i class="bi bi-save me-2"></i>
                                Perbarui Kategori</button>
                        </div>
                    </form>
                </div>
            </div>
