...
<div class="container-fluid fade-in-section">
    <div class="mb-4">
        ...
        <h3 class="fw-bold mt-2 text-dark">Tambah User Baru</h3>
    </div>
            ...
            <div class="card border-0 glass-card p-4">
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="user@sekolah.sch.id" required value="{{ old('email') }}">
                    </div>
                    ...
                    <div id="teacher-fields" style="display: none;" class="bg-light p-3 rounded-3 border mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="specialization" id="specialization" class="form-control" placeholder="Contoh: Konseling Pribadi & Sosial" value="{{ old('specialization') }}">
                        </div>
                    </div>

                    <div class="text-end mt-4">
                        <button type="submit" class="btn btn-primary-custom px-4"><i class="bi bi-save me-2"></i> Simpan User</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    // Run on load to persist old inputs
